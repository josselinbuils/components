...
describe('InputCheckGroup', () => {
  ...
  it('should set InputCheck children as required if no title', () => {
    wrapper.setProps({ inputGroupTitle: '', required: true });

    const firstInputCheck = wrapper.find(InputCheck).at(0);

    expect(firstInputCheck.prop('required')).toEqual(true);
  });
});
